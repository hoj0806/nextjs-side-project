...
export default function PostItem({ post, isLiked }: PostItemProps) {
  ...
  return (
    <Link
      href={`/study/${post.id}`}
      className='hover:scale-105 bg-white border-2 border-gray-300 shadow-sm rounded-3xl p-4 space-y-2 relative w-[300px] h-[340px] pl-[25px] pt-[50px] pr-[25px]'
    >
        ...
        <div className='flex items-center gap-20'>
          <div className='flex items-center gap-2'>
            <Image
              ...
              alt='profile_image'
            />
            <div className='truncate'>{post.author_nickname}</div>
          </div>
